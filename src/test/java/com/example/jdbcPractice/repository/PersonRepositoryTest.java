...
import com.example.jdbcPractice.repository.PersonRepository;
...
public class PersonRepositoryTest {
    ...
    public void testAddGet() {
        ...
        Person foundPerson = findInList(people, firstName, lastName);
        Assert.assertNotNull(foundPerson);

        Person foundPersonAgain = personRepository.getById(foundPerson.getId());
        Assert.assertNotNull(foundPersonAgain);
        Assert.assertEquals(firstName, foundPersonAgain.getFirstName());
        Assert.assertEquals(lastName, foundPersonAgain.getLastName());
    }
